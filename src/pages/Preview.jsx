...
import { getSuratRW } from "../services/surat";
  ...
  useEffect(() => {
    const fetchAll = async () => {
      try {
        ...
        const laporanRes = await getSuratRW(Number(idParam));
          ...
          >
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <tr>
                    <td>Kelurahan</td>
                    <td>:</td>
                    <td colSpan="4">Malaka Sari</td>
                  </tr>
                  <tr>
                    <td>Kecamatan</td>
                    <td>:</td>
                    <td colSpan="4">Duren Sawit</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            >
              ...
              <tbody>
                ...
                {/* Baris kosong untuk mengisi tabel */}
                {Array.from({
